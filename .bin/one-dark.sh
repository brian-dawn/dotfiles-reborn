...
color17=$color15 # Base 0F
color18=$color01 # Base 01
color19=$color02 # Base 02
color20=$color04 # Base 04
color21=$color06 # Base 06
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pl aab2bf # cursor
  printf $printf_template_custom Pm aab2bf # cursor text
else
